...
class Solution {
    ...
    public static void main(String[] args) {
       ...
       System.out.println("Enter length of the first LinkedList: ");
        ...
        ListNode head = getIntersectionNode(firstHead, secondHead);
        System.out.println("Intersecting Node is: "+head.val);
        sc.close();
    }
    ...
    public static ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        if(len1<len2){
            ...
            for(int i=1;i<=diff;i++)t2=t2.next;
        }
        else{
            
            for(int i=1;i<=diff;i++)t1=t1.next;
        }
