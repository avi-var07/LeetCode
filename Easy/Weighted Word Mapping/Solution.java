...
class Solution{
    public static void main(String[] args) {
        ...
        System.out.println("Enter 26 weigths: ");
        for(int i=0;i<26;i++)weights[i]=sc.nextInt();

        System.out.println(mapWordWeights(arr, weights));
    ...
    public static String mapWordWeights(String[] words, int[] weights) {
        ...
        for(String ele: words){
            int sum=0;
            for(char ch: ele.toCharArray())sum+=weights[ch-'a'];
